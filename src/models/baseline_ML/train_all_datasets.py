...
def main():
    ...
    print(f"\n{'='*80}")
    print("TESTING ON COMBINED DATASET (PHISHING + LEGIT)")
    print('='*80)
    ...
    for model in [LogisticRegressionModel(), NaiveBayesModel(), RandomForestModel()]:
        print(f"\nTraining {model.name}...")
        metrics = evaluate_model_on_dataset(model, X, y, 'combined')
